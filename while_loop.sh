...
while [[ ! -f "${SIGNAL_STOP_FILE}" ]]; do  # starts a loop that continues as long as the file does not exist
    echo "the file ${SIGNAL_STOP_FILE} does not yet exist..."  # prints a status message
